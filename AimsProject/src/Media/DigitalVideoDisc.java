...
public class DigitalVideoDisc extends Disc implements Playable{
    ...
    public boolean equals(Object o) {
        ...
        return this.getLength() == that.getLength() && Float.compare(that.getCost(), this.getCost()) == 0 && Objects.equals(getTitle(), that.getTitle()) && Objects.equals(getCategory(), that.getCategory()) && Objects.equals(getDirector(), that.getDirector());
    }
}
